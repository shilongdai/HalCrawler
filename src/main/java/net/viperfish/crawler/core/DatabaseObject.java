...
/**
 * A database that can be used to store objects. All implementing classes must ensure that the underlying mechanics guarantee thread safety.
...
public interface DatabaseObject<ID, T> {
	...
	/**
	 * saves the object. The object s would be saved. An auto-generated id should be assigned to the object.
	...
	/**
	 * saves a group of objects. All of the objects would be saved with a unique id assigned to each.
	...
	/**
	 * remove an individual object by the id. If the id is not associated with and specific object, nothing would be done.
	...
	/**
	 * query for an object with the assigned id. If no object is associated with the id, <code>null</code> would be returned.
	 * @param id the id assigned to the object.
	...
	/**
	 * find a group of objects from a group of ids. If a specific id has no association with any object, it will be skipped in the result.
	...
	/**
	 * closes all resources used by this {@link DatabaseObject}. It should ensure that no resources leak would occur.
